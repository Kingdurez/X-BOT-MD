    ...
    _0x5049fe.ev.on("messages.upsert", async _0x9a7b7a => {
      ...
      if (_0x14e10e) {
        ...
        if (!isNaN(_0x284411) && _0x284411 > 0x0 && _0x284411 <= _0x572788.length) {
          ...
          if (_0x32f8e7) {
            const _0x1a4a74 = 'https://api.fgmods.xyz/api/downloader/gdrive?url=' + _0x32f8e7 + "&apikey=g5PtmjBW";
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "MR DAVID | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *ᴅᴀᴠɪᴅ x*\n\n> x-ʙᴏᴛ-ᴍᴅ"
                }, {
                  'quoted': _0x171143
                });
              } else {
                  ...
                  await _0x3dfd8e.sendMessage(_0x4a183a, {
                    ...
                    'contextInfo': {
                      ...
                      'externalAdReply': {
                        ...
                        'body': "Download powered by Dᴀᴠɪᴅx",
                        'mediaType': 0x1,
...
cmd({
  ...
  try {
    ...
    const _0x59e841 = "https://api.fgmods.xyz/api/downloader/gdrive?url=" + _0x1ff06b + '&apikey=g5PtmjBW';
...
cmd({
  'pattern': "alldl",
  'alias': ['alldown', "dlallsocial"],
  'desc': "Download all social videos",
  'category': "download",
  'filename': __filename
}, async (_0xaf8db8, _0x52bd10, _0x4b2f59, {
  from: _0x1220b5,
  ...
  try {
    ...
    const _0x13f218 = await axios.get("https://bk9.fun/download/alldownload?url=" + _0x7e7f9b);
    const _0x467ca1 = _0x13f218.data;
    if (!_0x467ca1 || !_0x467ca1.status || !_0x467ca1.BK9) {
      return _0x4b2f59.reply("Failed to retrieve Media. Please check the link and try again.");
    }
    const {
      title: _0x2efe63,
      thumb: _0x247442,
